...
export function WelcomeScreen() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col items-center px-6 py-10 text-brand-text">
      ...
      <img src={assets.logo} alt={assets.logoAlt} className="mb-4 h-10 shrink-0" />

      <div className="flex w-full flex-1 flex-col items-center justify-center gap-6">
        <img src={assets.illustration} alt={assets.illustrationAlt} className="max-w-xs" />
